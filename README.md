...
Pull requests PROPOSE a change to a repository and requests that someone check over the changes and pull in contributions into their branch.

Forks clone whatever was pushed to your local machine
